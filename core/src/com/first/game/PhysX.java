    ...
    public void addObject(MapObject obj) {
        ...
        switch (name) {
            ...
            case "circle":
                ...
                def.position.set(new Vector2(ellipseMapObject.getEllipse().x + ellipseMapObject.getEllipse().width / 4, ellipseMapObject.getEllipse().y + ellipseMapObject.getEllipse().height / 4));
                circle.setRadius(ellipseMapObject.getEllipse().width / 4);
                fdef.shape = circle;
                break;
            default:
        }
